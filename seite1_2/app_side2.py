""" Docstring for the module
    ...
    This module creates the second side of our dashboard
    for a supplier-derivation analysis
"""
...
# define colors for the dashboard, that can changed quickly according to the styleguide
colors = {
...
app.title = "Dashboard for Supplier Derivation"
...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        ...
        html.Div(children=[
            html.H1("Supplier Deviation", className="header-title"),
            html.H2(children=[
    ...
    html.Div(children=[
        ...
        html.Div(children=[
            # numeric point chart with ordered spend/ number of orders deviated for the current year and
            # percentage of deviated orders (number/ net value) in the current year
            dcc.Graph(id="numeric-point-chart", className="card1"),
            # bar chart showing the deviations depending on deviation cause
            dcc.Graph(id="deviation_cause_chart", className="card2"),
        ]
        ),

        # Line chart for number of orders/ net value deviated per month 2020
        html.Div(dcc.Graph(id="month-line-chart", className="card3")),

        html.Div(children=[
            # bar chart showing the deviations depending on sales organisations
            dcc.Graph(id="deviation_sales_org", className="card4"),
            # bar chart showing the deviations of the top 10 suppliers
            dcc.Graph(id="deviation_top10", className="card5")
        ], )
    ],
        className="content")
])
...
@app.callback(
    [
        ...
        Output("deviation_cause_chart", "figure"),
        Output("month-line-chart", "figure"),
        Output("deviation_sales_org", "figure"),
        Output("deviation_top10", "figure"),
    ],
    [
        Input("os-nof", "value"),
...
def update_charts(
    ...
    # data for first part  of numeric point chart
    data_2020 = data_temp[data_temp["Year"] == 2020]
    data_abweichend = data_2020[data_2020["deviation cause"] != 0]
    # Converting column Purchasing. Org to a string
    data_abweichend["Purchasing Org."] = data_abweichend["Purchasing Org."].apply(lambda x: 'PO: ' + str(x))
    data_abweichend["deviation cause"] = data_abweichend["deviation cause"].apply(lambda x: 'DC: ' + str(x))
    net_value_abweichend = data_abweichend["Net Value"].sum()
    number_of_orders_abweichend = len(data_abweichend["Purchasing Doc."].unique())

    # data for second part of numeric point chart (percentage view)
    ...
    # data for bar chart 1: deviations per deviation cause
    deviation_per_deviation_caueses_nv = data_abweichend.groupby(["deviation cause"])["Net Value"].sum().reset_index()
    # deviation_per_deviation_caueses_nv = deviation_per_deviation_caueses_nv.apply(lambda x: 'EC: ' + str(x))
    ...
    # deviation_per_deviation_caueses_no = deviation_per_deviation_caueses_no.apply(lambda x: 'EC: ' + str(x))

    # data for line chart: deviation causes per month
    ...
    # data for bar chart 2: deviations per deviation cause
    ...
    # data for bar chart 3: deviations of the top 10 suppliers
    ...
    if data_temp.empty:
        ...
        if os_nof_value == 'net_value':
            ...
            bar_chart_figure1 = {
                ...
                "layout": {
                    "title": "Deviations per deviation-cause according to 'Net Value'",
                    "showlegend": True,
                    "paper_bgcolor": colors["paper_bgcolor"],
            ...
            line_chart_figure = {
                ...
                "layout": {
                    "title": "Deviated supplies per Month",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"]
                }
            ...
            bar_chart_figure2 = {
                "data": [],
                "layout": {
                    "title": "Deviations per purchasing organisation according to 'Net Value'",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"],
                    "xaxis": {
            ...
            bar_chart_figure3 = {
                "data": [],
                "layout": {
                    "title": "Deviations of top 10 suppliers according to 'Net Value'",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"],
                    "xaxis": {
        ...
        # if 'Number of orders' has been chosen we will come to this
            ...
            bar_chart_figure1 = {
                ...
                "layout": {
                    "title": "Deviations per deviation-cause according to Number of Orders",
                    "showlegend": True,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"]
                }
            ...
            line_chart_figure = {
                ...
                "layout": {
                    "title": "Number of deviated Orders per Month",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"]
                }
            ...
            bar_chart_figure2 = {
                "data": [],
                "layout": {
                    "title": "Deviations per purchasing organisation according to 'Number of Orders'",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"],
                    "xaxis": {
            ...
            bar_chart_figure3 = {
                "data": [],
                "layout": {
                    "title": "Deviations of top 10 suppliers according to 'Number of Orders'",
                    "showlegend": False,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"],
                    "xaxis": {
        ...
        if os_nof_value == 'net_value':
            ...
            bar_chart_figure1 = {
                'data': [
                    {
                        'x': deviation_per_deviation_caueses_nv["deviation cause"],
                        'y': deviation_per_deviation_caueses_nv["Net Value"],
                        'type': 'bar',
                        'name': '2020'
                    }
                ],
                "layout": {
                    "title": "Ordered spend per deviation cause according to 'Net Value'",
                    "showlegend": True,
                    "paper_bgcolor": colors["paper_bgcolor"],
                    "plot_bgcolor": colors["plot_bgcolor"]
                }
            ...
            bar_chart_figure1 = {
                'data': [
                    {
                        'x': deviation_per_deviation_caueses_no["deviation cause"],
                        'y': deviation_per_deviation_caueses_no["numbOrders"],
                        'type': 'bar',
                        'name': '2020'
                    }
                ],
